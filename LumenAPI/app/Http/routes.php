...
$app->put('/teachers/{teachers}/courses/{course}', 'TeacherCourseController@update');
$app->patch('/teachers/{teachers}/courses/{course}', 'TeacherCourseController@update');
$app->delete('/teachers/{teachers}/courses/{course}', 'TeacherCourseController@destroy');
